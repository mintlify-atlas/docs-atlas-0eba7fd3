---
title: "Introduction"
description: "CompoDex is a production-ready UI kit for serious Pokédex apps, built on shadcn/ui to handle complex Pokémon data with speed, consistency, and full customization."
---
...
<CardGroup cols={1}>
  <Card title="Installation" icon="download" href="/installation">
    Set up compo/dex in your existing shadcn/ui project in minutes.
  </Card>
</CardGroup>
